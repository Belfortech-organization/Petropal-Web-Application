...
const PostDetailsModal = ({ image, onClose, onPost, onBack }) => {
            ...
            <div style={{
              ...
              <div style={{ marginBottom: '18px' }}>
                <input
                  ...
                  style={{
                    ...
                    outline: 'none',
                    ':focus': { borderBottomColor: 'rgba(1,47,107,1)' }
                  }}
              ...
              <div 
                ...
                style={{
                  ...
                  ':hover': {
                    backgroundColor: 'rgba(1,47,107,0.05)',
                    borderColor: 'rgba(1,47,107,0.5)'
                  }
                }}
              >
                <div style={{
