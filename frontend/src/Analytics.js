...
const Analytics = () => {
    ...
    const [detailViewClosed, setDetailViewClosed] = useState(false); // Track if detailed view has been closed

    const handleViewAnalytics = (post) => {
        setSelectedPost(post);
        setShowDetailView(true);
        setDetailViewClosed(false); // Reset the flag when opening the detailed view
    };
    ...
    return (
        <>
            <style>{`
                ...
                .right-content {
                    width: ${showDetailView ? '50%' : '0'};
                    overflow-y: auto;
                    transition: all 0.3s ease;
                    padding: ${showDetailView ? '20px' : '0'};
                    border-left: ${showDetailView ? '1px solid #eee' : 'none'};
                }
                ...
                /* Add this new class */
                .vertical-layout .posts-row {
                    flex-direction: column;
                    align-items: center;
                }

                .vertical-layout .post-box {
                    width: 100%;
                    max-width: 100%;
                }
                .post-box {
                ...
                <div className="fixed-header">
                    ...
                    <div className="notification-header">
                        <button
                            ...
                            onClick={() => {
                                if (showDetailView) {
                                    setShowDetailView(false); // Close the detailed view
                                    setDetailViewClosed(true); // Set the flag to true
                ...
                <div className="scrollable-content">
                    <div className="split-view-container">
                        ...
                        "
                            ...
                            <div className={`top-posts-container ${showDetailView ? 'vertical-layout' : ''}`}>
                                    ...
                                    <div className="post-box" key={post.id}>
                                            <div className="post-content">
                                                <div className="post-left">
                                                    <div className="post-left-title">{post.title}</div>
                                                    <img src={post.image} alt="Post" />
                                                </div>
                                                <div className="post-right">
                                                    <div className="post-right-time">{post.time}</div>
                                            ...
                                            <div className="post-footer">
                                                <div className="post-footer-left">{post.impressions}</div>
                                                <div 
                        ...
                        <div className="right-content">
                            {showDetailView && selectedPost && (
                                <div className="detail-view">
                                    ...
                                    <div className="detail-title">Top Performing Posts</div>
                                    ...
                                    <div
                                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "21px", minWidth: "270px", 
                                                whiteSpace: "nowrap", color: "rgba(18,18,18,1)", lineHeight: "18.5px", 
                                                letterSpacing: "-0.01em", fontWeight: "500", marginBottom: "20px", textAlign: "center" }}
                                    >
                                    ...
                                    <div className="engagement-chart-container">
                                        ...
                                        <div style={{ textAlign: 'center' }}>
                                            ...
                                            <div style={{ width: '400px', height: '200px', backgroundColor: '#f0f0f0', 
                                    ...
                                    <div className="view-post-button">
                                        <div className="view-post-text">View Post</div>
                                    </div>
                                </div>
                            )}
                        </div>
