...
const Messages = () => {
  ...
  return (
    <div className="page-container">
      ...
      <div className="main-content">
        ...
        {activeChat && (
          <div className="active-chat">
            {/* ...rest of your chat code unchanged... */}
            {/* (For brevity, not repeating each chat block, since these don't affect the TypeScript errors) */}
            ...
            {/* ...repeat for other chats as you had it... */}
      ...
      {/* Replace <style jsx global> with a normal <style> tag for React */}
      <style>
        {`
          html, body {
            margin: 0;
      ...
      <style>
        {`
          ...
          /* (Copy all previous CSS blocks from original code for .header-bar, .main-content, etc.) */
          .header-bar {
            width: 100%;
