...
type AdCreationModalProps = {
  onClose: () => void;
  onUploadMedia: () => void;
  onBoostContent: () => void;
};

const AdCreationModal: React.FC<AdCreationModalProps> = ({ onClose, onUploadMedia, onBoostContent }) => {
  return (
    <div style={{
      position: 'fixed',
      top: 0,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div 
            className="ad-creation-modal-close-btn"
            style={{
              display: 'flex',
              justifyContent: 'center',
              alignItems: 'center',
        ...
        <div style={{
          ...
          {/* Upload Media Option */}
          <div 
            className="ad-creation-modal-option"
            style={{
              display: 'flex',
...
style.innerHTML = `
.ad-creation-modal-close-btn:hover {
  transform: scale(1.1);
}
.ad-creation-modal-option:hover {
